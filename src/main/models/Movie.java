...
public class Movie {
    ...
    public boolean equals(Object obj){
        ...
        return this.name.equals(movie.name) && this.format.equals(movie.format) && 
        this.rating == movie.rating && this.sellingPrice == movie.sellingPrice &&
        this.rentalPrice == movie.rentalPrice && this.isAvailable == movie.isAvailable;
    }
